...
gr.Interface(
    ...
    [
        ...
        gr.inputs.Image(type="pil", label="Person Image"),
        gr.inputs.Radio(
            choices=["yes", "no"],
            default="no",
            label="Retrieve original background from the person image?",
        ),
    ],
    gr.outputs.Image(type="pil", label="Predicted Output"),
    examples=[
        ["./sample_images/1/cloth.jpg", "./sample_images/1/person.jpg", "yes"],
